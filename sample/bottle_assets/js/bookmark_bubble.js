...
google.bookmarkbubble.Bubble.prototype.getIconUrl_ = function() {
  if (!this.iconUrl_) {
    ...
    if (!link || !(this.iconUrl_ = link.href)) {
      this.iconUrl_ = '/bottle_assets/images/apple-touch-icon_thumb.png';
    }
  }
...
google.bookmarkbubble.Bubble.prototype.build_ = function() {
  ...
  bubbleInner.style.padding = '25px 10px 20px 10px';
  bubbleInner.style.WebkitBorderRadius = '6px';
  bubbleInner.style.WebkitBoxShadow = '0 0 8px rgba(0, 0, 0, 0.7)';
  bubbleInner.style.WebkitBackgroundSize = '57px';
  ...
  if (this.getIosVersion_() >= this.getVersion_(4, 2)) {
    ...
    bubbleInner.innerHTML = 'このWebアプリをインストール！<br>矢印をタップして<b>ホーム画面に追加<b>';
  } else {
    /*bubbleInner.innerHTML = 'Install this web app on your phone: ' +
        'tap <b style="font-size:15px">+</b> and then ' +
        '<b>\'Add to Home Screen\'</b>';*/
    bubbleInner.innerHTML = 'このWebアプリをインストール！<br><b style="font-size:15px">+</b>をタップして<b>ホーム画面に追加<b>';
  }
  ...
  close.style.border = '16px solid transparent';
