...
$failenames =  $path_parts['filename'];
...
<link href="$url/bottle_assets/js/fancybox/jquery.fancybox.css" rel="stylesheet" media="screen" />
    <!-- Pickdate -->
<link rel="stylesheet" href="$url/bottle_assets/js/pickdate/themes/default.css">
<link rel="stylesheet" href="$url/bottle_assets/js/pickdate/themes/default.date.css">
  ...
  <div class="navbar navbar-default navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <ul class="nav navbar-nav_main">
              <li class="sp_none"><a href="$url/$url_dir">TOP</a></li>
...
<header>
  <div class="navbar navbar-default navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        <a href="./" class="navbar-brand"><img src="$url/bottle_assets/images/bottle_logo.svg">顧客・ボトル管理</a>
...
<div id="footer">
<copyright>Powerd by <a href="http://www.dewey.co.jp" target="_blank">DEWEY</a></copyright>
<div id="version">Version 2.0.3</div>
<div class="clear"></div>
</div>
...
<script src="$url/bottle_assets/js/fancybox/jquery.fancybox.js"></script>
<script src="$url/bottle_assets/js/addclear.js"></script>
<script src="$url/bottle_assets/js/common_search.js"></script>
</body>
