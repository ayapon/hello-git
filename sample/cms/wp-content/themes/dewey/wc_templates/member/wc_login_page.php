...
<div id="primary" class="site-content">
	...
	<?php if( have_posts() ) : usces_remove_filter(); ?>
		...
		<article class="post" id="wc_<?php usces_page_name(); ?>">
			...
			<h1 class="member_page_title">マイページログイン</h1>
			...
			<div id="memberpages">
				...
				<div class="whitebox">
					...
					<div class="header_explanation login_atention">
...
<!--
						<div class="new-entry">
							<h4><?php _e('Customers who are not member registration' , 'welcart_basic'); ?></h4>
							<p class="caption">ご利用には会員登録が必要です。プランお申込時に同時に会員登録することもできます。</p>
							<p id="nav">
