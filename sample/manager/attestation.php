	...
	<div class="well bs-component login_form">
		...
		<form name="form" method="post" action="$url">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-12">
                  <input type="text" name="f_id" class="form-control" id="inputID" value="test" placeholder="ID">
                </div>
				<div class="clear"></div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-12">
                  <input type="password" name="f_pass" class="form-control" id="inputPassword" value="12345" placeholder="Password">
                </div>
				<div class="clear"></div>
              </div>
