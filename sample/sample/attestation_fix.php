...
function check(){
	...
	if(!document.form.new_id.value.match(/^[!-~]+.{2,20}$/)){
		window.alert("ユーザー名は半角英数4〜20文字で入力してください");
		return false;
	}
	if(!document.form.new_pass1.value.match(/^[!-~]+.{3,20}$/)){
		window.alert("パスワードは半角英数4〜20文字で入力してください");
		return false;
	}
	//確認パスワードチェック
...
print <<< END_OF_HTML
        <div class="bs-component">
          <ul class="breadcrumb">
            <li><a href="./index.php">HOME</a></li>
            <li><a href="./admin.php">管理メニュー</a></li>
			<li class="active">ユーザー名・パスワード変更</li>
		</ul>
		</div>
...
print <<< END_OF_HTML
		<form name="form" method="post" action="$this_file" onSubmit="return check()" class="form-horizontal">
			...
			<div class="col-lg-12">
				<input name="new_id" type="text" value="$new_id" maxlength="20" class="form-control" placeholder="半角英数4〜20文字">
			</div>
			<div class="clear"></div>
			</div>
			...
			<div class="col-lg-12">
				<input name="new_pass1" type="password" value="$new_pass1" maxlength="20" class="form-control" placeholder="半角英数4〜20文字">
			</div>
			<div class="clear"></div>
			</div>
			...
			<div class="col-lg-12">
			  <input name="new_pass2" type="password" value="$new_pass2" maxlength="20" class="form-control" placeholder="再度同じパスワードを入力">
			</div>
			<div class="clear"></div>
			</div>
