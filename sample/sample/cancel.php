...
<tr>
	...
	<td>
                <input id="c_date" class="datepicker form-control form-tel" name="c_date" type="text" value="$c_date" placeholder="30日以降で解約日を指定">※ご利用料金は月単位で、日割り返還は行なっておりません。
	</td>
	</tr>
  <tr>
...
<script src="../bottle_assets/js/pickdate/picker.js"></script>
<script src="../bottle_assets/js/pickdate/picker.date.js"></script>
<script src="../bottle_assets/js/pickdate/legacy.js"></script>
<script src="../bottle_assets/js/pickdate/translations/ja_JP.js"></script>
