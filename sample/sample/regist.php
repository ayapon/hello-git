...
$file_pref = "../bottle_assets/config/pref.dat";
$file_birthyear = "../bottle_assets/config/birthyear.dat";
$file_birthmonth = "../bottle_assets/config/birthmonth.dat";
$file_birthday = "../bottle_assets/config/birthday.dat";
//ＧＥＴ受信
$cnt = @$_GET["cnt"];
...
if (!$cnt){
	if ($counts >= $uplan_limit - 5 ){
		...
		$message_error = "ご利用プランの登録可能件数はあと<strong>".$remaining."件</strong>です";
		$message_error2 = "<br /><span>プランのご変更は<a href='/usces-member' target='_blank'>契約ユーザーログイン</a>で行えます</span>";
	}
	if ($counts >= $uplan_limit){
		$message_error = "ご利用プランの登録可能件数は<strong>".$uplan_limit."件</strong>までです";
		$message_error2 = "<br /><span>プランのご変更は<a href='/usces-member' target='_blank'>契約ユーザーログイン</a>で行えます</span>";
		$form_none = 1;
		$disabled = "disabled";
	}
...
<input type="text" name="otherbottle" value="$otherbottle" class="form-category form-control otherbottle" maxlength="40" placeholder="その他のボトル" $disabled>
		<input type="text" name="otherbottle_num" value="$otherbottle_num" class="form-category3 form-control otherbottle" placeholder="タグ番号等" maxlength="4" $disabled><input type="text" name="otherbottle_quant" value="$otherbottle_quant" class="form-category2 form-control otherbottle" placeholder="残量等" maxlength="4" $disabled>
      </td>
</tr>
END_OF_HTML;
}
...
print <<< END_OF_HTML
        <div class="bs-component">
          <div class="jumbotron">
            <h2 class="alart_message">登録できません</h2>
<br />
          </div>
