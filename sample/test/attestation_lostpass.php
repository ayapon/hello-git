...
global $this_file,$new_pass1,$new_pass2;
//-------------------------------------------------------↓
html_header1();
...
print <<< END_OF_HTML
		<form name="form" method="post" action="$this_file" onSubmit="return check()" class="form-horizontal">
			...
			<p>※入力したパスワードは忘れないよう控えてください。</p>
			
<div class="footer_navi">
            <a href="./" class="btn btn-default">TOPへ</a>
