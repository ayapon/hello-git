...
if ($submit){
	...
	if (!$message_error){
		...
		$line_custom['dspimg_log']     = $dspimg_log;
		//ユーザーファイル書き込み
...
//-------------------------------------------------------↓
print <<< END_OF_HTML
<input type="checkbox" name="lastvisit_log" class="form-control" value="true" $value> チェックで表示</label>
	</td>
  </tr>
<tr>
    <th>画像アップロード <div class="infotip"><abbr title="チェックを外すと、画像アップロード項目を非表示にします。" rel="tooltip">?</abbr></div></th>
    <td>
END_OF_HTML;
//-------------------------------------------------------↑
if ($line_custom['dspimg_log'] == "true"){
	$value = "checked";
}else{
	$value = "";
}
//-------------------------------------------------------↓
print <<< END_OF_HTML
<label><input type="checkbox" name="dspimg_log" class="form-control" value="true" $value> チェックで表示</label>
	</td>
  </tr>
<tr>
...
//-------------------------------------------------------↓
print <<< END_OF_HTML
<label><input type="checkbox" name="company_log" class="form-control" value="true" $value> チェックで表示</label>
	</td>
  </tr>
<tr>
...
//-------------------------------------------------------↓
print <<< END_OF_HTML
<label><input type="checkbox" name="addr_log" class="form-control" value="true" $value> チェックで表示</label>
	</td>
  </tr>
<tr>
...
//-------------------------------------------------------↓
print <<< END_OF_HTML
<label><input type="checkbox" name="phone_log" class="form-control" value="true" $value> チェックで表示</label>
	</td>
  </tr>
<tr>
...
//-------------------------------------------------------↓
print <<< END_OF_HTML
<label><input type="checkbox" name="mobile_log" class="form-control" value="true" $value> チェックで表示</label>
	</td>
  </tr>
<tr>
...
//-------------------------------------------------------↓
print <<< END_OF_HTML
<label><input type="checkbox" name="birthday_log" class="form-control" value="true" $value> チェックで表示</label>
	</td>
  </tr>
<tr>
...
//-------------------------------------------------------↓
print <<< END_OF_HTML
<label><input type="checkbox" name="friends_log" class="form-control" value="true" $value> チェックで表示</label>
	</td>
  </tr>
<tr>
...
//-------------------------------------------------------↓
print <<< END_OF_HTML
<label><input type="checkbox" name="pic_log" class="form-control" value="true" $value> チェックで表示</label>
	</td>
  </tr>
